    ...
    <div class="row justify-content-center" style="margin-top: 150px">
        <div class="col-lg-6">
            <main class="form-registration">
                <h1 class="h3 mb-3 fw-normal text-center">Registration | Stok</h1>
                ...
                <small class="d-block mt-3">Have an account? <a class="text-dark" style="text-decoration: none" href="/login"> Login
                        Here</a></small>
            </main>
        </div>
    </div>
